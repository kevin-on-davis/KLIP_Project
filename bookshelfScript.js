...
$("#picture").empty();
    ...
    $("#reviews").empty();
    $("#reviews").append("Avg. Rating: " + response.items[0].volumeInfo.averageRating);
    ...
    if (navigator.geolocation)
   {
       ...
       function success(pos)
       {
           ...
           console.log(latitude)
            ...
            searchBorder = (longitude-0.05).toFixed(6) + "," + (latitude-0.05).toFixed(6) + "," + (longitude+0.05).toFixed(6) + "," + (latitude+0.05).toFixed(6)
            console.log(searchBorder)
            // searchBorder = "-79.397015,43.601070,-79.307015,43.691070"
            // console.log(searchBorder)
            searchTerm = "starbucks"
            // toronto = "-79.347015,43.651070" 
            
            url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${searchTerm}.json?bbox=${searchBorder}&access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw`
